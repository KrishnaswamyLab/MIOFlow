...
# %% auto 0
__all__ = ['ToyODE', 'make_model', 'Autoencoder', 'ToyModel', 'ToySDEModel', 'GrowthRateModel', 'GrowthRateModelSDE']
...
class GrowthRateModelSDE(ToySDEModel):
    def __init__(self, func, method='euler', noise_type='diagonal', sde_type='ito',
                 in_features=2, out_features=2, gunc=None, dt=0.1, m_init=1., m_transform=lambda x: x):
