# AUTOGENERATED! DO NOT EDIT! File to edit: 06_constants.ipynb (unless otherwise specified).

__all__ = ['__file', 'ROOT_DIR', 'DATA_DIR', 'NTBK_DIR', 'IMGS_DIR', 'RES_DIR', 'WORM_FILE', 'EB_BODIES_FILE',
           'EB_BODIES_PSEUDO_4', 'EB_BODIES_PSEUDO_6', 'EB_BODIES_PSEUDO_25', 'EB_BODIES_PSEUDO_82', 'DYNGEN_INFO_FILE',
           'DYNGEN_EXPR_FILE']
